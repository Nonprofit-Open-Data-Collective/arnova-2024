...
The glass cliff phenomenon suggest that financial precarious NPs (seen by a significant drop in their financials between T-2 and T-1) would more likely hire a female to the CEO position. We start by looking at the DAR variable. MM and MF organizations follow very similar trajectories. Interesting, FM transitions display the trajectory we would expect for a glass cliff. The PER metric tells a different story (as differing financial metrics tend to do). We do not observe any big change in PER for any for the groups before a transition. Interesting, the MM group experiences significant PER increases after the new transitions. 
\
\
As a final understanding of the data, we look at the distribution of the financial variables at T-1. We consider the two most relevant groups of MM and MF. We see that the distribution of financial variables tends to be extremely similar to both types of transitions, failing to provide strong evidence for a glass cliff phenonemon.
\ 
\
The work in this paper presents some of the first attempts to investigate the glass cliff phenomenon. Although no conclusive evidence was found, the larger importance of this piece was to show access to 990 data through the data commons and encourage further exploration on your own. Happy data-ing!
