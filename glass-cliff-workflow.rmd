...
Typically you would not need to replicate this step since it is a computationally-intensive process. It can take a couple of days to build the full efile database. It is much easier to pull existing CSV files from NCCS: [**EFILE DATA CATALOG**](https://nccs.urban.org/nccs/catalogs/catalog-efile.html).
...
ceo_trans_1000_fncl[ 1:40, keep ] %>% pander::pander()
```
...
## Step 8: Combine CEO Panel and Financials
...
# Pull from NCCS using helper functions: 
